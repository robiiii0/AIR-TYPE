...
Engine::Network::Client::Client(struct sockaddr_in address, const int socket_fd)
...
std::size_t Engine::Network::Client::getId() const
{
    return _id;
}
...
int Engine::Network::Client::getSocketFd() const
{
    return _socket_fd;
}

bool Engine::Network::Client::isThreaded() const
{
    return _is_threaded;
}

bool Engine::Network::Client::isConnected() const
{
