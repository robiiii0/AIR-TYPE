    ...
    namespace LocalStorage {
        class LocalStorageModule {
            public:
                 ...
                 * @return The lines of the file that contain the string or an
                 * empty string if no line contains the string
                 */
                std::string readFromFile(const std::string& filename,
                 ...
                 * @return The first line of the file that contains the string
                 * or an empty string if no line contains the string
                 */
                std::string getLineFromFile(const std::string& filename,
                                            const std::string& contains);
